...
void board_print() {
    ...
    cout<<endl<<"\t\u001b[0m\u001b[4m\u001b[41mSCORE:\u001b[0m "<<score<<"\t\t\t\t\t\u001b[4m\u001b[41mLIVES:\u001b[0m "<<life<<"\n\n";
}
    ...
    for(int k=0; k<4; k++) {
        if(pacman.i==ghost[k].i && pacman.j==ghost[k].j) {
            ...
            if(life == 0) {
                ...
                cout<<"      ░       ░  ░       ░      ░  ░       ░ ░        ░     ░  ░   ░     "<<endl;
                cout<<"                                                     ░                   \u001b[0m"<<endl<<endl;
                cout<<"\u001b[41m\u001b[1mYOUR SCORE:\u001b[0m "<<score<<endl;
                system("stty echo");
                exit(1);
            }
            else {
...
void about() {
    ...
    cout<<"\n\u001b[0m\u001b[4m\u001b[1mWELCOME TO PAC-MAN !";
    cout<<"\u001b[0m\nThe rules are very simple:\n";
    cout<<"\u001b[44m\u001b[4mPACMAN\u001b[0m \u001b[33m< \u001b[0m:This is you\n";
    cout<<"\u001b[44m\u001b[4mGHOSTS\u001b[0m  \u001b[32mH \u001b[35mH \u001b[36mH \u001b[38;5;167mH \u001b[0m: Stay away from them\n";
    cout<<"\u001b[44m\u001b[4mCHERRY\u001b[0m  \u001b[31m %\u001b[0m: You have to eat this to increase score\n";
    cout<<"\u001b[44m\u001b[4mPOWER PELLET\u001b[0m  \u001b[33mo\u001b[0m: After eating this, you can eat ghosts\u001b[34m h\u001b[0m to score points,\nbut beware this only works for a small duration\n";
